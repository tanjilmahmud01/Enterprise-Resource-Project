...
echo "<section class='bg-primary'>
	<article class='py-5 text-center text-white'>
	 	<div>
	 		<h3 class='display-4 text-white'>Delete an Employee</h3>
...
?>	
	...
	<?php
		...
		echo "<form action = 'populate_delete_employee_dropdown.php' method= 'post'>";
		echo " ‎<label for='employees' class='btn btn-dark'>‏‏‎ ‎Choose an employee to delete : ‎</label>";
