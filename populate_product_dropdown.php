...
";
	...
	echo "<p>";
		echo "<label for= 'prodname' class='btn btn-dark col-sm-2' >Product Name:</label>";
		echo "<input type= 'text' name= 'name' id=prodname value = '$selected_option' required>";
	echo "</p>";
	
	echo "<p>";
		echo "<label for= 'price' class='btn btn-dark col-sm-2'>Unit Price:</label>";
		echo "<input type= 'text' name= 'unit_price' id=price value = '$unitprices' required>";
	echo "</p>";
	
	echo "<p>";
		echo "<label for= 'currentstock' class='btn btn-dark col-sm-2' >Current Stock:</label>";
		echo "<input type= 'text' name= 'current_stock' id=currentstock value = '$currentstocks' required>";
	echo "</p>";
	
	echo "<p>";
		echo "<label for= 'minstock' class='btn btn-dark col-sm-2'>Minimum Stock:</label>";
		echo "<input type= 'text' name= 'min_stock' id=minstock value = '$minstocks' required>";
	echo "</p>";
	
	echo "<input type='submit' class='btn btn-warning col-sm-1' value='UPDATE'>";
